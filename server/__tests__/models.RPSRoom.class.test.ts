...
describe('Test the RockPaperScissorsRoom', () => {
  ...
  test('room_full method - should be false', () => {
    room = new RockPaperScissorsRoom(room_id, 100); // clear the player choices
